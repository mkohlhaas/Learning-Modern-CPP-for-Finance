...
void par_barrier_same_as_no_par ();     // Quick test -- compare with earlier serial
                                        // example
...
// void perf_test_results_no_barrier_one_seed();		// Sub-Top
// calling function void perf_test_results_with_barrier_one_seed();
// // Sub-Top calling function void
// perf_tests_euro_no_barrier_examples_one_seed(double time_to_exp, int
// time_steps, int num_scenarios); void
// perf_tests_euro_with_barrier_examples_one_seed(double time_to_exp, int
// time_steps, int num_scenarios);
