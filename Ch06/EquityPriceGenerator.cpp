...
EquityPriceGenerator::EquityPriceGenerator (double spot, int num_time_steps, double time_to_expiration,
    ...
    : spot_{ spot }, num_time_steps_{ num_time_steps }, time_to_expiration_{ time_to_expiration },
      volatility_{ volatility }, rf_rate_{ rf_rate }, div_rate_{ div_rate }, dt_{ time_to_expiration / num_time_steps }
{
}

std::vector<double>
EquityPriceGenerator::operator() (int seed) const
{
  std::vector<double> v;
