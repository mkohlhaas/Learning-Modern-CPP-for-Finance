...
public:
  ...
  */
  ...
  // options:
  MCOptionValuation (OptionInfo &&opt, int time_steps, double vol, double int_rate, double div_rate = 0.0,
                     BarrierType barrier_type = BarrierType::none, double barrier_value = 0.0);
  ...
  // calc_price(.) is generalized further to accommodate up/down-and-out
  // barriers:
