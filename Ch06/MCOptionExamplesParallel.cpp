...
void
mc_option_examples_parallel () // Top calling function
{
...
void
perf_tests_euro_with_barrier_examples (double time_to_exp, int num_time_steps, int num_scenarios)
{
  using std::cout, std::format;
  cout << "\n" << "*** perf_tests_euro_with_barrier_examples() ***" << "\n";
  cout << format ("Time to exp = {}, num time steps = {}, num scenarios = {}\n\n", time_to_exp, num_time_steps,
                  num_scenarios);
