...
void
print_dynamic_mdspan (size_t m, size_t n, const std::vector<double> &v)
{
  cout << "\n" << "*** dynamic_mdspan(" << m << ", " << n << ")*** " << "\n";
  using std::vector, std::size_t;
...
submdspan_examples ()
{
  ...
  cout << "Modify last element of 2nd column submdspan; what happens to "
          "original mdspan?: "
       << "\n";
  col_2[2] = 3333;
