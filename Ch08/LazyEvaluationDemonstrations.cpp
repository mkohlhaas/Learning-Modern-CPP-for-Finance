...
void
lazy_evaluation_demonstration () // Top calling function
{
...
naive_vector_addition ()
{
  // Calls operator + (const std::vector<double>& a, const std::vector<double>&
  // b) See definition just above.
...
std::vector<double>
sum_four_vectors (const std::vector<double> &a, const std::vector<double> &b, const std::vector<double> &c,
...
{
public:
  SumOfFourVectors (const std::vector<double> &a, const std::vector<double> &b, const std::vector<double> &c,
                    const std::vector<double> &d)
      : a_{ a }, b_{ b }, c_{ c }, d_{ d }
  {
    assert (a.size () == b.size ());
