...
double
CallPayoff03::payoff (double spot) const
{
  return std::max (spot - strike_, 0.0); // #include <algorithm>
}

CallPayoff03 *
CallPayoff03::clone () const
{
...
double
PutPayoff03::payoff (double spot) const
{
  return std::max (strike_ - spot, 0.0);
}

PutPayoff03 *
PutPayoff03::clone () const
{
...
double
CallPayoff::payoff (double spot) const
{
  return std::max (spot - strike_, 0.0);
}

std::unique_ptr<Payoff>
CallPayoff::clone () const
{
...
double
PutPayoff::payoff (double spot) const
{
  return std::max (strike_ - spot, 0.0);
}

std::unique_ptr<Payoff>
PutPayoff::clone () const
{
