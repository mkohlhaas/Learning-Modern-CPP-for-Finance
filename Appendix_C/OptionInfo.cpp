...
OptionInfo::OptionInfo (OptionInfo &&rhs) noexcept : payoff_ptr_{ std::exchange (rhs.payoff_ptr_, nullptr) },
...
OptionInfo &
OptionInfo::operator= (OptionInfo &&rhs) noexcept // Implemented move assignment
{
