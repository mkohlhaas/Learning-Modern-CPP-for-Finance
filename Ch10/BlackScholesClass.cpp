  ...
  if (time_to_exp_ > 0.0)
    {
      ...
      auto norm_cdf = [] (double x) -> double { return (1.0 + std::erf (x / std::numbers::sqrt2)) / 2.0; };
...
double
implied_volatility (BlackScholes &&bsc, double opt_mkt_price, double x0, double x1, double tol, unsigned max_iter)
{
