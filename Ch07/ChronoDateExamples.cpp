...
ctor_ymd ()
{
  ...
  cout << "21st century date = " << d4 << ", days since 1970.01.01 = " << d4.serial_date ()
       << ", type = " << typeid (d4.serial_date ()).name () << endl;
  cout << "20th century date after UNIX epoch = " << d2 << ", days since 1970.01.01 = " << d2.serial_date () << endl;
  cout << "20th century date before UNIX epoch = " << d3 << ", days before 1970.01.01 = " << -d3.serial_date () << endl;
...
ctor_default ()
{
  ...
  cout << "Default date = " << def << ", days since 1970.01.01 = " << def.serial_date () << endl;
...
test_add_fcns ()
{
  ...
  d1.add_years (1);
  cout << d1 << endl;
  cout << std::boolalpha << "ChronoDate d1 year: " << (d1.year () == 1971) << "; month: " << (d1.month () == 1)
       << "; day: " << (d1.day () == 1) << endl;
  ...
  cout << "ChronoDate d1 year: " << (d1.year () == 1969) << "; month: " << (d1.month () == 1)
       << "; day: " << (d1.day () == 1) << endl
       << endl;
  // cout << "result = " << d1 << ", new serial date = " << d1.serial_date() <<
  // endl << endl;

  cout << "Start date (d5): " << d5 << endl;
  cout << "Serial date = " << d5.serial_date () << endl << "Add one year: " << d5.add_years (1) << endl;
  ...
  d4.add_months (7);
  cout << "Add 7 months -- ChronoDate d4 year: " << (d4.year () == 2017) << "; month: " << (d4.month () == 2)
       << "; day: " << (d4.day () == 22) << endl;
  ...
  cout << "Add 2 months -- ChronoDate d6 year: " << (d6.year () == 2000) << "; month: " << (d6.month () == 2)
       << "; day: " << (d6.day () == 29) << endl;
  cout << "result = " << d6 << endl;
  cout << "New serial date = " << d6.serial_date () << endl << endl;

  // Test if start date is 29th (December) and end date is in February in
  // non-leap year
  ...
  d2.add_days (365);
  cout << "Add 365 days -- ChronoDate d2 year: " << (d2.year () == 1974) << "; month: " << (d2.month () == 10)
       << "; day: " << (d2.day () == 26) << endl;
  cout << "result = " << d2 << endl;
  cout << "New serial date = " << d2.serial_date () << endl << endl;
  d2.add_days (-365);
  cout << "Add -365 days -- ChronoDate d2 year: " << (d2.year () == 1973) << "; month: " << (d2.month () == 10)
       << "; day: " << (d2.day () == 26) << endl;
  cout << "result = " << d2 << endl;
  cout << "New serial date = " << d2.serial_date () << endl << endl;
}
