...
void
multi_array ()           // Top level calling function
{
...
euro_atm_call ()
{
  ...
  double strike = 36.0, rf_rate = 0.06, mkt_vol = 0.2,
         time_to_exp = 1.0; // div_rate = 0.0 (default)
  int    time_steps{ 4 };
  double spot{ 36.0 };
  ...
  std::cout << std::setprecision (2) << format ("strike = {}, spot = {}, price = {}", strike, spot, opt_price) << "\n"
            << "\n";
...
amer_itm_put ()
{
  ...
  // Dividend default is 0, but you can put it in if you like (uncomment the
  // last argument):
  double strike = 40.0, rf_rate = 0.06, mkt_vol = 0.2,
         time_to_exp = 1.0; // div_rate = 0.0 (default)
  int    time_steps  = 4;
  double spot        = 36.0;
  ...
  std::cout << std::setprecision (2) << format ("strike = {}, spot = {}", strike, spot) << "\n\n";
...
lattice_pricing_convergence ()
{
  ...
  cout << format ("American Put Option: strike = {}, rf rate = {}, vol = {}", strike, rf_rate, mkt_vol) << "\n";
  cout << format ("time to exp (yr) = {}, ann div rate = {}, spot = {}", time_to_exp, 0, spot) << "\n\n";
